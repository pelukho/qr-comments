...
<main class="main">
    <header class="header container-fluid">
        <div class="row justify-content-center">
            <div class="header__logo col-10 col-sm-8 col-md-4 text-center">
            ...
            <nav class="language">
                <a class="language__item {{ App::getLocale() !== 'ru' ? 'current' : '' }}" href="{{ route('home') }}">UA</a>
                <a class="language__item {{ App::getLocale() === 'ru' ? 'current' : '' }}" href="{{ route('home', 'ru') }}">RU</a>
            </nav>
        </div>
    </header>
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-md-7">
                <div class="text-description">
                    <p>
                        {{ __('Если у Вас есть пожелания или замечания относительно качества предоставленных нами услуг,
                                просим Вас оставить отзыв. Все сообщения будут переданы руководству.') }} <br>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <form id="review-form" class="review-form">
                    ...
                    <div class="mb-3">
                        <textarea name="review_content" class="form-control" id="review" rows="3"
                                  placeholder="{{ __('Введите отзыв *') }}"></textarea>
                    </div>
